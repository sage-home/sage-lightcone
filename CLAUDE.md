...
This file provides guidance to Claude Code (claude.ai/code) when working with code in this repository.  All files including ther README.md are visible whenever this file is created or updated.
