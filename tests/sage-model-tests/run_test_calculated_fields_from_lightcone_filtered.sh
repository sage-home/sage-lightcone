...
run_with_profiling "cli_lightcone" "$BENCHMARK_CSV" \
    ...
    --dataset ${OUTPUTDIR}/${RAWNAME}-kdtree-onestep.h5 \
    --filterfield cosmological_redshift --filtermin 0 --filtermax 0.6 \
    --decmin 0 --decmax 1 --ramin 0 --ramax 1 --zmin 0 --zmax 1 \
    --outdir ${OUTPUTDIR} --outfields distance snapnum ra dec cosmological_redshift observed_redshift sfr --outfile $RAWNAME--filtered-lightcone.h5
