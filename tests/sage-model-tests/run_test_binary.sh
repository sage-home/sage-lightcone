...
export OUTPUTDIR=output_sage_binary
...
${MY_ROOT}/bin/sage2h5 -m convert -v 2 -s ${OUTPUTDIR}/millennium -p input/millennium_minus1.par -a input/millennium/trees/millennium.a_list -o ${OUTPUTDIR}/${RAWNAME}-depthfirstordered.h5
...
${MY_ROOT}/bin/cli_lightcone --dataset ${OUTPUTDIR}/$RAWNAME-kdtree.h5 --decmin 0 --decmax 1 --ramin 0 --ramax 1 --zmin 0 --zmax 1 --outdir ${OUTPUTDIR} --outfile $RAWNAME-lightcone.h5
