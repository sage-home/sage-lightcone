    ...
    namespace h5 {
        ...
        class file : public location {
          public:
            ...
            template <class T> void write_serial(std::string const &name, std::vector<T> const &buf) {
            ...
            // template< class T >
            // void reada(const std::string& name, Vector<T,2>& data, const MPI::Comm& comm=MPI::Comm::SELF, int
            // splitDim=0);

            // template<class T>
            // void reada(const std::string& name, Vector<T,2>& data, const VectorView<hsize_t>& elems, const MPI::Comm&
            // comm=MPI::Comm::SELF);
