...
namespace hpc {
    namespace h5 {
        ...
        file::file(std::string const &filename, unsigned flags, mpi::comm const &comm, property_list const &props) :
        ...
        void
            file::open(std::string const &filename, unsigned flags, mpi::comm const &comm, property_list const &props) {
            _comm = &comm;
        ...
        // template<>
        // void file::write(const std::string& name, const VectorView<int>& data, const VectorView<hsize_t>& chunkSize,
        ...
        // template<>
        // void file::write(const std::string& name, const VectorView<int,2>& data, const VectorView<hsize_t>&
        // chunkSize, const Comm& comm, int splitDim, bool deflate) {
        //     Vector<int> dataSize(2);
        //     dataSize[0] = data.getSize(0);
        //     dataSize[1] = data.getSize(1);
        ...
        // template<>
        // void file::write(const std::string& name, const VectorView<float>& data, const VectorView<hsize_t>&
        // chunkSize, const Comm& comm, bool deflate) {
        //     Vector<int> dataSize(1);
        //     dataSize[0] = data.getSize();
        ...
        // template<>
        // void file::write(const std::string& name, const VectorView<float,2>& data, const VectorView<hsize_t>&
        // chunkSize, const Comm& comm, int splitDim, bool deflate) {
        //     Vector<int> dataSize(2);
        //     dataSize[0] = data.getSize(0);
        //     dataSize[1] = data.getSize(1);
        ...
        // template<>
        // void file::write(const std::string& name, const VectorView<double>& data, const VectorView<hsize_t>&
        // chunkSize, const Comm& comm, bool deflate) {
        //     Vector<int> dataSize(1);
        //     dataSize[0] = data.getSize();
        ...
        // template<>
        // void file::write(const std::string& name, const VectorView<double,2>& data, const VectorView<hsize_t>&
        // chunkSize, const Comm& comm, int splitDim, bool deflate) {
        //     Vector<int> dataSize(2);
        //     dataSize[0] = data.getSize(0);
        //     dataSize[1] = data.getSize(1);
        ...
        // void file::write(const std::string& name, const VectorView<int>& dataSize, const void* data, DataType&
        // dataType, const Comm& comm, int splitDim) {
        //     this->write(name, dataSize, data, dataType, VectorView<hsize_t>(), comm, splitDim, false);
        // }

        // void file::write(const std::string& name, const VectorView<int>& dataSize, const void* data, DataType&
        // dataType, const VectorView<hsize_t>& chunkSize, const Comm& comm, int splitDim, bool deflate) {
        ...
        // template<>
        // void file::write(const std::string& name, const CSR<int>& data, const VectorView<hsize_t>& chunkSize, const
        // Comm& comm, bool deflate) {
        ...
        // template<>
        // void file::write(const std::string& name, const CSR<float>& data, const VectorView<hsize_t>& chunkSize, const
        // Comm& comm, bool deflate) {
        ...
        // template<>
        // void file::write(const std::string& name, const CSR<double>& data, const VectorView<hsize_t>& chunkSize,
        // const Comm& comm, bool deflate) {
        //     this->writeCSR(name, data.getDispls(), data, DataType::NATIVE_DOUBLE, chunkSize, comm, deflate);
        // }

        // void file::writeCSR(const std::string& name, const VectorView<int>& displs, const void* data, DataType&
        // dataType, const Comm& comm) {
        //     this->writeCSR(name, displs, data, dataType, VectorView<hsize_t>(), comm, false);
        // }

        // void file::writeCSR(const std::string& name, const VectorView<int>& displs, const void* data, DataType&
        // dataType, const VectorView<hsize_t>& chunkSize, const Comm& comm, bool deflate) {
        ...
        //     this->write<int>(name + "_displs", VectorView<int>(displs, displs.getSize() - 1), chunkSize, comm,
        //     deflate); offsDispls.sub(rankOffs);
        ...
        // template<>
        // void file::writeInterlaced(const std::string& name, const CSR<int>& data, hsize_t size, const
        ...
        // void file::writeInterlaced(const std::string& name, const VectorView<int>& dataDispls, const void* data,
        // const DataType& dataType, hsize_t size, const VectorView<int>& offsets, const MPI::Comm& comm) {
        //     assert_throw(size >= 0,
        ...
        // #endif
        //     assert_throw((dataDispls.getSize() == 0 && offsets.getSize() == 0) || (dataDispls.getSize() - 1 ==
        //     offsets.getSize()),
        ...
        // template<>
        // void file::read(const std::string& name, VectorView<int> data, const VectorView<hsize_t>& elems, const
        // MPI::Comm& comm) { #ifndef NDEBUG
        //     Vector<hsize_t> dims;
        ...
        // template<>
        // void file::read(const std::string& name, VectorView<float> data, const VectorView<hsize_t>& elems, const
        // MPI::Comm& comm) { #ifndef NDEBUG
        //     Vector<hsize_t> dims;
        //     this->readDataDims(name, dims);
        //     assert_throw(elems.getSize()%dims.getSize() == 0,
        ...
        // template<>
        // void file::read(const std::string& name, VectorView<double> data, const VectorView<hsize_t>& elems, const
        // MPI::Comm& comm) { #ifndef NDEBUG
        //     Vector<hsize_t> dims;
        //     this->readDataDims(name, dims);
        //     assert_throw(elems.getSize()%dims.getSize() == 0,
        ...
        // template<>
        // void file::reada(const std::string& name, Vector<int>& data, const VectorView<hsize_t>& elems, const
        // MPI::Comm& comm) {
        //     Vector<hsize_t> dims;
        //     this->readDataDims(name, dims);
        ...
        // template<>
        // void file::reada(const std::string& name, Vector<double,2>& data, const VectorView<hsize_t>& elems, const
        // Comm& comm) {
        //     Vector<hsize_t> dims;
        //     this->readDataDims(name, dims);
        //     assert_throw(dims.getSize() == 2,
        ...
        // void file::read(const std::string& name, void* data, DataType& dataType, const VectorView<hsize_t>& elems,
        // const Comm& comm) {
        //     DataSet fileSet;
        //     fileSet.open(*this, name);
        //     DataSpace fileSpace;
