...
namespace hpc {
    namespace h5 {
        ...
        datatype::datatype(datatype const &src) : _id(-1) {
            *this = src;
        }
        ...
        void datatype::close() {
            if(_id > -1 && (_id != H5T_NATIVE_CHAR && _id != H5T_NATIVE_INT && _id != H5T_NATIVE_UINT &&
                            ...
                            _id != H5T_STRING && _id != H5T_STD_I32BE && _id != H5T_STD_I64BE && _id != H5T_STD_U32BE &&
                            _id != H5T_STD_U64BE && _id != H5T_IEEE_F32BE && _id != H5T_IEEE_F64BE) &&
