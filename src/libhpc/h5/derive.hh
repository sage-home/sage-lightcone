...
public:
    ...
    void add(const h5::datatype& mem_type, hsize_t mem_offs, const h5::datatype& file_type,
             const std::string& desc = "");

    void add2(h5::datatype const& mem_type, hsize_t mem_offs, std::string const& desc = "",
