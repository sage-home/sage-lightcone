...
//       MPI_INSIST(MPI_Reduce(data.data(), inc_data.data(), data.size(),
//       MPI_INT, op, root, this->_comm)); boost::copy(inc_data, data.begin());
//    }
//    else {
//       MPI_INSIST(MPI_Reduce(data.data(), NULL, data.size(), MPI_INT, op,
//       root, this->_comm));
//    }
// }
