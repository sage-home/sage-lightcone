...
#define MPI_MAP_TYPE(T) mapped_type<T>::type_id

typedef boost::mpl::map<
    boost::mpl::pair<unsigned char, boost::mpl::int_<MPI_BYTE>>,
...
#define MPI_MAP_TYPE(T) hpc::mpi::_type_map[mapped_type<T>::type_id]
