...
std::vector<unsigned> const balanced_partition::displs() const { return _displs; }

std::vector<unsigned> const balanced_partition::indices() const { return _idxs; }

std::vector<int> const balanced_partition::partners() const { return _partners; }
