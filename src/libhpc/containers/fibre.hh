...
///
template <class T>
class fibre_iterator : public std::iterator<std::random_access_iterator_tag, vector<T>, ptrdiff_t,
                                            T*, typename vector<T>::view>
{
public:
    ...
    bool operator==(const fibre_iterator& op) const { return this->_ptr == op._ptr; }

    bool operator!=(const fibre_iterator& op) const { return !this->operator==(op); }
...
template <class T>
class const_fibre_iterator
    : public std::iterator<std::random_access_iterator_tag, vector<T>, ptrdiff_t, const T*,
...
public:
    ...
    bool operator==(const const_fibre_iterator& op) const { return this->_ptr == op._ptr; }

    bool operator!=(const const_fibre_iterator& op) const { return !this->operator==(op); }
...
public:
    ...
    const_iterator begin() const { return const_iterator(vector<T>::begin(), this->_fibre_size); }

    iterator begin() { return iterator(vector<T>::begin(), this->_fibre_size); }

    const_iterator end() const { return const_iterator(vector<T>::end(), this->_fibre_size); }
    ...
    const typename vector<T>::view back() const { return (*this)[_num_fibres - 1]; }
...
template <class T>
const_fibre_iterator<T> operator+(ptrdiff_t op_a, const const_fibre_iterator<T>& op_b)
{
