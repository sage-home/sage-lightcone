...
namespace hpc {
    ...
    ///
    ///
    template <class T, class Value> class range_map : public std::map<range<T>, Value> {
      public:
    ...
    class range_map_insert_iterator : public boost::iterator_facade<range_map_insert_iterator<T, Value>,
                                                                    std::pair<range<T>, Value &>,
                                                                    std::forward_iterator_tag,
                                                                    std::pair<range<T>, Value &>> {
      public:
        range_map_insert_iterator(range_map<T, Value> &map, const range<T> &range, const Value &value) :
      ...
      protected:
        ...
        void _overlap() {
            ...
            else if(_low->first.start() >= _range.start() && _low->first.start() < _range.finish() &&
