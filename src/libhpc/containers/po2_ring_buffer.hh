...
namespace hpc {
    ...
    template <class T> class po2_ring_buffer_iterator;

    ///
    ///
    ///
    template <class T> class po2_ring_buffer {
      public:
      ...
      public:
        ...
        template <class Iterator> size_type insert(Iterator start, const Iterator &finish) {
    ...
    class po2_ring_buffer_iterator
        : public boost::iterator_facade<po2_ring_buffer_iterator<T>, T, std::random_access_iterator_tag, const T> {
        friend class boost::iterator_core_access;

      public:
        typedef boost::iterator_facade<po2_ring_buffer_iterator<T>, T, std::random_access_iterator_tag, const T>
                                                       super_type;
        typedef T                                      value_type;
      ...
      public:
        po2_ring_buffer_iterator(const po2_ring_buffer<value_type> &buffer, size_type idx) : _buf(buffer), _idx(idx) {
        }

        po2_ring_buffer_iterator(const po2_ring_buffer_iterator &src) : _buf(src._buf), _idx(src._idx) {
        }
      ...
      protected:
        ...
        difference_type distance_to(const po2_ring_buffer_iterator &op) const {
            return op._idx - _idx;
        }
