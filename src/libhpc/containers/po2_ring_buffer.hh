...
class po2_ring_buffer_iterator
    : public boost::iterator_facade<po2_ring_buffer_iterator<T>, T,
                                    std::random_access_iterator_tag, const T> {
  friend class boost::iterator_core_access;

public:
  typedef boost::iterator_facade<po2_ring_buffer_iterator<T>, T,
                                 std::random_access_iterator_tag, const T>
      super_type;
  typedef T value_type;
