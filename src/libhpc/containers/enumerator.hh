...
namespace hpc {
    ...
    class enumerator : public boost::iterator_adaptor<enumerator<Iter, Num>,
                                                      Iter,
      ...
      public:
        ...
        bool operator==(const Iter &op) const {
    ...
    template <class Iter, class Num>
    class renumerator : public boost::iterator_adaptor<renumerator<Iter, Num>,
                                                       Iter,
