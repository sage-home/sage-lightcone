    ...
    namespace os {
        ...
        class file_descriptor {
          ...
          public:
            ...
            file_descriptor(fs::path const &pathname, file_descriptor::flags_type flags = file_descriptor::READ_ONLY);
            ...
            void open(fs::path const &pathname, file_descriptor::flags_type flags = file_descriptor::READ_ONLY);
