...
namespace hpc {
    ...
    template <class T> class matrix {
      ...
      public:
        ...
        matrix(size_type n_rows, size_type n_cols) : _vec(n_rows * n_cols), _size{n_rows, n_cols} {
        }
    ...
    class matrix_rows_iterator
        : public boost::
              iterator_facade<matrix_rows_iterator<T>, hpc::view<T>, std::random_access_iterator_tag, hpc::view<T>> {
      ...
      public:
        ...
        template <class U>
        matrix_rows_iterator(matrix_rows_iterator<U> const &src) : _ptr(src._ptr), _row_size(src._row_size) {
        }
