...
template <class T>
class view_iterator
    : public boost::iterator_facade<view_iterator<T>, T, std::random_access_iterator_tag>
{
...
protected:
    ...
    template <class U>
    bool equal(const view_iterator<U>& op) const
    {
        return _ptr == op._ptr;
    }
    ...
    template <class U>
    size_t distance_to(const view_iterator<U>& op) const
    {
        return op._ptr - _ptr;
    }
