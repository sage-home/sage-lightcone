...
///
template <class Map>
struct map_derefer : public std::unary_function<typename Map::key_type,
...
struct element
    : public std::unary_function<const Array &, typename Array::value_type> {
...
struct element_tuple
    : public std::unary_function<
          const Tuple &, typename boost::tuples::element<Index, Tuple>> {
