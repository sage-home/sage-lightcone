...
static double const default_ridders_xtol = 1e-8;
static unsigned const default_ridders_max_its = 60;

template <class Function, class T>
T ridders(Function func, T x1, T x2, unsigned* num_its = 0, T xtol = default_ridders_xtol,
          unsigned max_its = default_ridders_max_its)
{
    // Evaluate boundaries.
    T f1, f2;
    f1 = func(x1);
