...
private:
    ...
    bool equal(sort_permute2_iter const& other) const { return this->_si == other._si; }

    typename sort_permute2_iter_helper_type<SortIter, PermuteIter1, PermuteIter2>::reference_type
    dereference() const
    {
        return typename sort_permute2_iter_helper_type<SortIter, PermuteIter1,
                                                       PermuteIter2>::reference_type(*this->_si,
                                                                                     *this->_pi1,
                                                                                     *this->_pi2);
    }
...
{
    typedef
        typename sort_permute2_iter_helper_type<SortIter, PermuteIter1, PermuteIter2>::value_type T;
