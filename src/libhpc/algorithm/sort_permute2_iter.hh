...
namespace hpc {
    ...
    template <class SortIter, class PermuteIter1, class PermuteIter2> struct sort_permute2_iter_helper_type {
    ...
    class sort_permute2_iter
      ...
      public:
        ...
        sort_permute2_iter(SortIter si, PermuteIter1 pi1, PermuteIter2 pi2) : _si(si), _pi1(pi1), _pi2(pi2) {
        }
      ...
      private:
        ...
        typename sort_permute2_iter_helper_type<SortIter, PermuteIter1, PermuteIter2>::reference_type
            dereference() const {
            return typename sort_permute2_iter_helper_type<SortIter, PermuteIter1, PermuteIter2>::reference_type(
                *this->_si, *this->_pi1, *this->_pi2);
        }
