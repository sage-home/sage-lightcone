...
template <class SortIter, class PermuteIter1, class PermuteIter2>
struct sort_permute2_iter_helper_type {
  typedef boost::tuple<typename std::iterator_traits<SortIter>::value_type,
                       ...
                       typename std::iterator_traits<PermuteIter2>::value_type>
      value_type;
  typedef boost::tuple<
...
class sort_permute2_iter
    : public boost::iterator_facade<
          ...
          typename sort_permute2_iter_helper_type<SortIter, PermuteIter1,
                                                  PermuteIter2>::value_type,
          std::random_access_iterator_tag,
          typename sort_permute2_iter_helper_type<SortIter, PermuteIter1,
                                                  PermuteIter2>::reference_type,
...
private:
  ...
  bool equal(sort_permute2_iter const &other) const {
  ...
  typename sort_permute2_iter_helper_type<SortIter, PermuteIter1,
                                          PermuteIter2>::reference_type
  dereference() const {
    return typename sort_permute2_iter_helper_type<
        SortIter, PermuteIter1, PermuteIter2>::reference_type(*this->_si,
                                                              *this->_pi1,
                                                              *this->_pi2);
  }
  ...
  difference_type distance_to(sort_permute2_iter const &other) const {
...
struct sort_permute2_iter_compare
    : public std::binary_function<
          ...
          typename sort_permute2_iter_helper_type<SortIter, PermuteIter1,
                                                  PermuteIter2>::value_type,
          bool> {
  typedef typename sort_permute2_iter_helper_type<SortIter, PermuteIter1,
                                                  PermuteIter2>::value_type T;
