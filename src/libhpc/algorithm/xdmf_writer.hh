...
namespace hpc {
    ...
    template <class IterT>
    void write_xdmf_h5_field(h5::file &         h5_file,
                             const std::string &name,
                             IterT const &      begin,
                             IterT const &      end,
                             mpi::comm const &  comm = mpi::comm::world);
    ...
    template <class IterT>
    void write_xdmf_h5_particles(h5::file &         h5_file,
                                 const std::string &grid,
                                 IterT const &      begin,
                                 IterT const &      end,
                                 mpi::comm const &  comm) {
    ...
    class xdmf_writer {
      public:
        ...
        template <class IterT>
        void open_grid(std::string const &name,
                       IterT const &      begin,
                       IterT const &      end,
                       mpi::comm const &  comm = mpi::comm::world) {
            _grid = name;
        ...
        template <class IterT> void write_field(const std::string &name, IterT const &begin, IterT const &end) {
