...
void permute(SeqT const& seq_begin, SeqT const& seq_end, IdxT const& idx_begin)
{
...
///
template <class SeqT, class IdxT>
void permuteANY(SeqT const& seq_begin, SeqT const& seq_end, IdxT const& idx_begin, int nfields)
{
    typedef typename SeqT::value_type seq_type;
    typedef typename IdxT::value_type idx_type;
