...
struct tuple_wrapper
{
    ...
    operator std::tuple<typename std::remove_reference<Args>::type...>() { return data; }
};
...
protected:
    ...
    bool equal(sort_permute_iter const& other) const { return this->_si == other._si; }

    typename sort_permute_iter_helper_type<SortIter, PermuteIter>::reference_type
    dereference() const
    {
        return typename sort_permute_iter_helper_type<SortIter, PermuteIter>::reference_type(
            *this->_si, *this->_pi);
    }
