...
///
template <class ProjT, class LiftT, class SideT>
...
/// Lift dispatch.
///
template <class LiftT, size_t D, class ProjT, class SideT>
CUDA_DEV_HOST LiftT lift(ProjT idx, SideT const &sides) {
...
///
template <class LiftT, class ProjT, class SideT>
