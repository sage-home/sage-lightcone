...
namespace hpc {
    ...
    ///
    template <class ProjT, class LiftT, size_t D, class SideT> struct lift_impl;

    ///
    /// 2D lift implementation.
    ///
    template <class ProjT, class LiftT, class SideT> struct lift_impl<ProjT, LiftT, 2, SideT> {
        CUDA_DEV_HOST
        static LiftT lift(ProjT idx, SideT const &sides) {
    ...
    ///
    template <class ProjT, class LiftT, class SideT> struct lift_impl<ProjT, LiftT, 3, SideT> {
        CUDA_DEV_HOST
        static LiftT lift(ProjT idx, SideT const &sides) {
            typedef typename LiftT::value_type lift_index_type;
    ...
    /// Lift dispatch.
    ///
    template <class LiftT, size_t D, class ProjT, class SideT> CUDA_DEV_HOST LiftT lift(ProjT idx, SideT const &sides) {
    ...
    ///
    template <class LiftT, class ProjT, size_t D, class SideT> struct project_impl;

    ///
    /// 2D project implementation.
    ///
    template <class LiftT, class ProjT, class SideT> struct project_impl<LiftT, ProjT, 2, SideT> {
        CUDA_DEV_HOST
        static ProjT project(LiftT const &crd, SideT const &sides) {
#ifndef NDEBUG
    ...
    ///
    template <class LiftT, class ProjT, class SideT> struct project_impl<LiftT, ProjT, 3, SideT> {
        CUDA_DEV_HOST
        static ProjT project(LiftT const &crd, SideT const &sides) {
#ifndef NDEBUG
    ...
    /// Project dispatch.
    ///
    template <class ProjT, size_t D, class LiftT, class SideT>
    CUDA_DEV_HOST ProjT project(LiftT const &crd, SideT const &sides) {
    ...
    namespace cuda {
        ...
        ///
        CUDA_DEV_HOST_INL
        uint3 lift(uint const &idx, uint3 const &sides) {
        ...
        CUDA_DEV_HOST
        uint project(uint3 const &crd, uint3 const &sides) {
