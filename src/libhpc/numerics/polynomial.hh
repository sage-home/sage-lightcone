    ...
    namespace polynomial {
        ...
        template <class T> class jacobi {
          public:
            ...
            jacobi(value_type alpha, value_type beta) : _order(1), _alpha(alpha), _beta(beta) {
            }

            jacobi(unsigned order, value_type alpha, value_type beta) : _order(order), _alpha(alpha), _beta(beta) {
            }
            ...
            value_type previous_order() const {
                return this->_p1;
            }
        ...
        template <class T> class jacobi_norm : public jacobi<T> {
          public:
            ...
            jacobi_norm(value_type alpha, value_type beta) : jacobi<value_type>(alpha, beta) {
                this->_norm = this->_calc_norm(this->_order);
            }

            jacobi_norm(unsigned order, value_type alpha, value_type beta) : jacobi<value_type>(order, alpha, beta) {
        ...
        template <class Jacobi> class jacobi_derivative : Jacobi {
          public:
            ...
            jacobi_derivative(value_type alpha, value_type beta) : Jacobi(alpha + 1.0, beta + 1.0) {
            }
        ...
        template <class Polynomial1D> class tensor_product {
          public:
            ...
            tensor_product(unsigned dim, unsigned order, const Polynomial1D &poly) : _dim(dim), _poly(poly) {
