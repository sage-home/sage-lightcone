...
public:
    ...
    template <class Iter>
    void set_iqr(Iter const& start, unsigned size)
    {
...
template <class T, class Bandwidth, class Kernel>
class kde_base
{
public:
    typedef T value_type;
...
public:
    ...
    typename hpc::view<std::vector<value_type>> const points() const { return _pnts; }
...
template <
    class T, class Bandwidth = bandwidths::constant<T>, class Kernel = kernels::epanechnikov<T>,
    class Enable =
