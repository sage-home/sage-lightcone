...
namespace hpc {
    ...
    class interp_iterator : public boost::iterator_facade<interp_iterator<Grid0Iterator, Grid1Iterator, Value>,
                                                          Value,
      ...
      public:
        ...
        const boost::array<size_t, 2> &indices() const {
            return _idxs;
        }
    ...
    template <class Grid0Iterator, class Grid1Iterator, class Value = typename Grid0Iterator::value_type>
