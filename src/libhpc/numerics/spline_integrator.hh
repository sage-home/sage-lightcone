    ...
    namespace num {
        ...
        template <class T> class spline_integrator {
          ...
          public:
            ...
            template <class Spline, class Func> value_type operator()(const Spline &sp, Func func) const {
                value_type sum = 0.0;
            ...
            template <class Spline, class Func> value_type reverse(const Spline &sp, Func func) const {
                value_type sum = 0.0;
                for(unsigned ii = 0; ii < sp.num_segments(); ++ii) {
        ...
        template <class T> class spline_spline_integrator {
          ...
          public:
            ...
            value_type operator()(const Spline0 &sp0, const Spline1 &sp1, Func func) const {
                ...
                auto it = make_interp_iterator(sp0.knot_points().begin(),
                                               sp0.knot_points().end(),
