...
///
///
template <class DiagVec, class OffDiagVec = DiagVec, class RHSVec = DiagVec, class SolVec = DiagVec,
                        ...
                        typename type_traits<WorkVec>::reference work)
{
    ...
    sol[ii] =
        (rhs[ii] - sol[ii - 1] * off_diag[ii - 1]) / (diag[ii] - work[ii - 1] * off_diag[ii - 1]);
