...
namespace hpc {
    namespace num {
        ...
        ///
        ///
        template <class T, class PointsSeq = std::vector<T>, class ValuesSeq = std::vector<T>> class spline {
          public:
          ...
          public:
            ...
            const knot_points_type &knot_points() const {
                return _pnts;
            }

            const knot_values_type &knot_values() const {
                return _vals;
            }
            ...
            value_type segment_start(unsigned seg) const {
                return _pnts[seg];
            }

            value_type segment_finish(unsigned seg) const {
                return _pnts[seg + 1];
            }
            ...
            knot_points_type &points() {
                return _pnts;
            }

            knot_values_type &values() {
                return _vals;
            }
            ...
            typename hpc::view<std::vector<value_type>> const ai() const {
                return _ai;
            }

            typename hpc::view<std::vector<value_type>> const bi() const {
                return _bi;
            }
