...
TEST_CASE("construct/parallel")
{
    ...
    TEST(fix.kdt.bounds()[1][0] == 1.0);
    TEST(fix.kdt.bounds()[1][1] == 11.0);
    TEST(fix.kdt.bounds()[2][0] == 1.0);
    TEST(fix.kdt.bounds()[2][1] == 10.0);

    TEST(fix.bp.n_elems() == 5);
    TEST(fix.bp.n_gelems() == 5 * n_ranks);

    DELTA(fix.crds[0][0], 1.0 + fix.base, 1e-1);
    DELTA(fix.crds[1][0], 1.0, 1e-1);
    DELTA(fix.crds[2][0], 1.0, 1e-1);
    DELTA(fix.crds[0][1], 2.0 + fix.base, 1e-1);
    DELTA(fix.crds[1][1], 2.0, 1e-1);
    DELTA(fix.crds[2][1], 10.0, 1e-1);
    DELTA(fix.crds[0][2], 3.0 + fix.base, 1e-1);
    DELTA(fix.crds[1][2], 11.0, 1e-1);
    DELTA(fix.crds[2][2], 2.0, 1e-1);
    DELTA(fix.crds[0][3], 11.0 + fix.base, 1e-1);
    DELTA(fix.crds[1][3], 4.0, 1e-1);
    DELTA(fix.crds[2][3], 2.5, 1e-1);
    DELTA(fix.crds[0][4], 12.0 + fix.base, 1e-1);
    DELTA(fix.crds[1][4], 8.0, 1e-1);
    DELTA(fix.crds[2][4], 3.0, 1e-1);
}
...
TEST_CASE("iterator/bounds")
{
    ...
    if (n_ranks == 1)
    {
        ...
        auto it = fix.kdt.begin();
        TEST(it.bounds()[0][0] == 1.0);
        TEST(it.bounds()[0][1] == 12.0);
        TEST(it.bounds()[1][0] == 1.0);
        TEST(it.bounds()[1][1] == 11.0);
        TEST(it.bounds()[2][0] == 1.0);
        TEST(it.bounds()[2][1] == 10.0);
        ++it;
        TEST(it.bounds()[0][0] == 1.0);
        TEST(it.bounds()[0][1] == 6.5);
        TEST(it.bounds()[1][0] == 1.0);
        TEST(it.bounds()[1][1] == 11.0);
        TEST(it.bounds()[2][0] == 1.0);
        TEST(it.bounds()[2][1] == 10.0);
        ...
        TEST(it.bounds()[1][1] == 6.0);
        TEST(it.bounds()[2][0] == 1.0);
        TEST(it.bounds()[2][1] == 5.5);
        ++it;
        TEST(it.bounds()[0][0] == 1.0);
        TEST(it.bounds()[0][1] == 6.5);
        TEST(it.bounds()[1][0] == 1.0);
        TEST(it.bounds()[1][1] == 6.0);
        TEST(it.bounds()[2][0] == 5.5);
        TEST(it.bounds()[2][1] == 10.0);
        ++it;
        TEST(it.bounds()[0][0] == 1.0);
        TEST(it.bounds()[0][1] == 6.5);
        TEST(it.bounds()[1][0] == 6.0);
        TEST(it.bounds()[1][1] == 11.0);
        TEST(it.bounds()[2][0] == 1.0);
        TEST(it.bounds()[2][1] == 10.0);
        ++it;
        TEST(it.bounds()[0][0] == 6.5);
        TEST(it.bounds()[0][1] == 12.0);
        TEST(it.bounds()[1][0] == 1.0);
        TEST(it.bounds()[1][1] == 11.0);
        TEST(it.bounds()[2][0] == 1.0);
        ...
        TEST(it.bounds()[0][1] == 12.0);
        TEST(it.bounds()[1][0] == 1.0);
        TEST(it.bounds()[1][1] == 4.0);
        TEST(it.bounds()[2][0] == 1.0);
        TEST(it.bounds()[2][1] == 10.0);
        ++it;
        TEST(it.bounds()[0][0] == 6.5);
        TEST(it.bounds()[0][1] == 12.0);
        TEST(it.bounds()[1][0] == 4.0);
        TEST(it.bounds()[1][1] == 11.0);
        TEST(it.bounds()[2][0] == 1.0);
        TEST(it.bounds()[2][1] == 10.0);
    }
