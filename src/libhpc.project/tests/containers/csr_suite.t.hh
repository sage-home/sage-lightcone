...
public:
    ...
    void test_get_num_rows() { TS_ASSERT_EQUALS(this->src.num_rows(), this->num_rows); }
    ...
    void test_3phase()
    {
        ...
        csr_3phase(10, displs, array, values.begin(), values.end(), hpc::map_get(mapping),
                   hpc::set_has(pred));
    ...
    void test_3phase_indices()
    {
        ...
        csr_3phase(10, displs, array, indices, values.begin(), values.end(), hpc::map_get(mapping),
                   hpc::set_has(pred));
