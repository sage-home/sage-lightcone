...
struct kdtree_fixture
{
    kdtree_fixture()
    {
        ...
        crds[0].push_back(1.0);
        crds[1].push_back(1.0);
        crds[2].push_back(1.0);
        crds[0].push_back(2.0);
        crds[1].push_back(2.0);
        crds[2].push_back(10.0);
        crds[0].push_back(3.0);
        crds[1].push_back(11.0);
        crds[2].push_back(2.0);
        crds[0].push_back(11.0);
        crds[1].push_back(4.0);
        crds[2].push_back(2.5);
        crds[0].push_back(12.0);
        crds[1].push_back(8.0);
        crds[2].push_back(3.0);
    ...
    hpc::kdtree<> kdt;
    hpc::binary_partitioner<std::array<std::vector<double>, 3>::iterator, permute> bp;
    std::array<std::vector<double>, 3> crds;
    double base;
};
