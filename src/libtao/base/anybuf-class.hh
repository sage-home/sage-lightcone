...
#if !defined(__BIG_ENDIAN__) && (defined(WIN32) || defined(MIPSEL) || defined(LINUX) || defined(LIN) || defined(i386) || defined(__x86_64))
...
public:
	...
	int32_t popLittleEndianUInt16Array(int32_t elements, uint16_t *values, int32_t skip_elements = 0) {
	...
	int32_t popLittleEndianUInt32Array(int32_t elements, uint32_t *values, int32_t skip_elements = 0) {
