...
real_type integrate(hpc::num::spline_integrator<real_type> const& integ, Spline const& sp)
{
...
template <class Spline>
real_type integrate(const Spline& sp)
{
...
real_type integrate(const hpc::num::spline_spline_integrator<real_type>& integ, const Spline0& sp0,
                    const Spline1& sp1)
{
