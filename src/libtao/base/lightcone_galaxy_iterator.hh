...
class lightcone_galaxy_iterator
    : public boost::iterator_facade<lightcone_galaxy_iterator<BackendT>,
                                    batch<typename BackendT::real_type>&, std::forward_iterator_tag,
...
public:
    ...
    lightcone_galaxy_iterator(tao::lightcone const& lc, backend_type& be, query<real_type>& qry,
                              tile_iterator tile_it, tao::batch<real_type>* bat = 0,
...
protected:
    ...
    bool equal(const lightcone_galaxy_iterator& op) const { return _done == op._done; }
