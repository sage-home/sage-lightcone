...
/// These fields are required for the sage2kdtree -> cli_lightcone pipeline to function.
...
/// Validate that all mandatory SAGE fields are present in the available fields list.
/// Uses case-insensitive matching to be flexible with field name variations.
///
/// @param available_fields List of field names available in the HDF5 file
/// @param missing_fields Output vector of missing field names (will be cleared first)
