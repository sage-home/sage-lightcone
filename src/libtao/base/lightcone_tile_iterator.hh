...
namespace tao {
   ...
   class lightcone_tile_iterator
      : public boost::iterator_facade< lightcone_tile_iterator,
                                       tile<real_type>,
   ...
   public:
      ...
      remaining_tiles() const;

      std::map<std::array<int,3>,int> const&
      done_tiles() const;

      void
      save_checkpoint( boost::property_tree::ptree& pt ) const;
   ...
   protected:
      ...
      bool
      equal( lightcone_tile_iterator const& op ) const;
