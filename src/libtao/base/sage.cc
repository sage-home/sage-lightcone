...
void make_hdf5_types(h5::datatype& mem_type, h5::datatype& file_type)
{
    ...
    der.add(h5::datatype::native_int, HOFFSET(galaxy, snapshot), h5::datatype::native_int,
            "snapnum");
    der.add(h5::datatype::native_int, HOFFSET(galaxy, type), h5::datatype::native_int, "type");
    der.add(h5::datatype::native_llong, HOFFSET(galaxy, galaxy_idx), h5::datatype::native_llong,
            "galaxy_index");
    der.add(h5::datatype::native_llong, HOFFSET(galaxy, central_galaxy_idx),
            h5::datatype::native_llong, "central_galaxy_index");
    der.add(h5::datatype::native_int, HOFFSET(galaxy, sage_halo_idx), h5::datatype::native_int,
            "sage_halo_index");
    der.add(h5::datatype::native_int, HOFFSET(galaxy, sage_tree_idx), h5::datatype::native_int,
            "sage_tree_index");
    der.add(h5::datatype::native_llong, HOFFSET(galaxy, simulation_halo_idx),
            h5::datatype::native_llong, "simulation_halo_index");
    der.add(h5::datatype::native_int, HOFFSET(galaxy, local_index), h5::datatype::native_int,
            "local_index");
    der.add(h5::datatype::native_llong, HOFFSET(galaxy, global_index), h5::datatype::native_llong,
            "global_index");
    der.add(h5::datatype::native_int, HOFFSET(galaxy, descendant), h5::datatype::native_int,
            "descendant");
    der.add(h5::datatype::native_llong, HOFFSET(galaxy, global_descendant),
            h5::datatype::native_llong, "global_descendant");
    der.add(h5::datatype::native_int, HOFFSET(galaxy, subsize), h5::datatype::native_int,
            "subsize");
    der.add(h5::datatype::native_int, HOFFSET(galaxy, merge_type), h5::datatype::native_int,
            "merge_type");
    der.add(h5::datatype::native_int, HOFFSET(galaxy, merge_into_id), h5::datatype::native_int,
            "merge_into_id");
    ...
    der.add(h5::datatype::native_float, HOFFSET(galaxy, pos[0]), h5::datatype::native_float,
            "posx");
    der.add(h5::datatype::native_float, HOFFSET(galaxy, pos[1]), h5::datatype::native_float,
            "posy");
    der.add(h5::datatype::native_float, HOFFSET(galaxy, pos[2]), h5::datatype::native_float,
            "posz");
    der.add(h5::datatype::native_float, HOFFSET(galaxy, vel[0]), h5::datatype::native_float,
            "velx");
    der.add(h5::datatype::native_float, HOFFSET(galaxy, vel[1]), h5::datatype::native_float,
            "vely");
    der.add(h5::datatype::native_float, HOFFSET(galaxy, vel[2]), h5::datatype::native_float,
            "velz");
    der.add(h5::datatype::native_float, HOFFSET(galaxy, spin[0]), h5::datatype::native_float,
            "spin_x");
    der.add(h5::datatype::native_float, HOFFSET(galaxy, spin[1]), h5::datatype::native_float,
            "spin_y");
    der.add(h5::datatype::native_float, HOFFSET(galaxy, spin[2]), h5::datatype::native_float,
            "spin_z");
    der.add(h5::datatype::native_int, HOFFSET(galaxy, num_particles), h5::datatype::native_int,
            "n_darkmatter_particles");
    der.add(h5::datatype::native_float, HOFFSET(galaxy, mvir), h5::datatype::native_float,
            "virial_mass");
    der.add(h5::datatype::native_float, HOFFSET(galaxy, central_mvir), h5::datatype::native_float,
            "central_galaxy_mvir");
    der.add(h5::datatype::native_float, HOFFSET(galaxy, rvir), h5::datatype::native_float,
            "virial_radius");
    der.add(h5::datatype::native_float, HOFFSET(galaxy, vvir), h5::datatype::native_float,
            "virial_velocity");
    der.add(h5::datatype::native_float, HOFFSET(galaxy, vmax), h5::datatype::native_float,
            "max_velocity");
    der.add(h5::datatype::native_float, HOFFSET(galaxy, vel_disp), h5::datatype::native_float,
            "velocity_dispersion");
    der.add(h5::datatype::native_float, HOFFSET(galaxy, cold_gas), h5::datatype::native_float,
            "cold_gas");
    der.add(h5::datatype::native_float, HOFFSET(galaxy, stellar_mass), h5::datatype::native_float,
            "stellar_mass");
    der.add(h5::datatype::native_float, HOFFSET(galaxy, bulge_mass), h5::datatype::native_float,
            "bulge_mass");
    der.add(h5::datatype::native_float, HOFFSET(galaxy, hot_gas), h5::datatype::native_float,
            "hot_gas");
    der.add(h5::datatype::native_float, HOFFSET(galaxy, ejected_mass), h5::datatype::native_float,
            "ejected_mass");
    der.add(h5::datatype::native_float, HOFFSET(galaxy, blackhole_mass), h5::datatype::native_float,
            "blackhole_mass");
    ...
    der.add(h5::datatype::native_float, HOFFSET(galaxy, metals_hot_gas), h5::datatype::native_float,
            "metals_hot_gas");
    der.add(h5::datatype::native_float, HOFFSET(galaxy, metals_ejected_mass),
            h5::datatype::native_float, "metals_ejected_mass");
    der.add(h5::datatype::native_float, HOFFSET(galaxy, metals_ics), h5::datatype::native_float,
            "metals_ics");
    der.add(h5::datatype::native_float, HOFFSET(galaxy, sfr_disk), h5::datatype::native_float,
            "sfr_disk");
    der.add(h5::datatype::native_float, HOFFSET(galaxy, sfr_bulge), h5::datatype::native_float,
            "sfr_bulge");
    der.add(h5::datatype::native_float, HOFFSET(galaxy, sfr_disk_z), h5::datatype::native_float,
            "sfr_disk_z");
    der.add(h5::datatype::native_float, HOFFSET(galaxy, sfr_bulge_z), h5::datatype::native_float,
            "sfr_bulge_z");
    der.add(h5::datatype::native_float, HOFFSET(galaxy, disk_scale_radius),
            h5::datatype::native_float, "disk_scale_radius");
    der.add(h5::datatype::native_float, HOFFSET(galaxy, cooling), h5::datatype::native_float,
            "cooling");
    der.add(h5::datatype::native_float, HOFFSET(galaxy, heating), h5::datatype::native_float,
            "heating");
    der.add(h5::datatype::native_float, HOFFSET(galaxy, quasar_mode_bh_accretion_mass),
            h5::datatype::native_float, "quasar_mode_bh_accretion_mass");
    der.add(h5::datatype::native_float, HOFFSET(galaxy, time_of_last_major_merger),
            h5::datatype::native_float, "time_of_last_major_merger");
    der.add(h5::datatype::native_float, HOFFSET(galaxy, time_of_last_minor_merger),
            h5::datatype::native_float, "time_of_last_minor_merger");
    der.add(h5::datatype::native_float, HOFFSET(galaxy, outflow_rate), h5::datatype::native_float,
            "outflow_rate");
    der.add(h5::datatype::native_float, HOFFSET(galaxy, infall_mvir), h5::datatype::native_float,
            "infall_mvir");
    der.add(h5::datatype::native_float, HOFFSET(galaxy, infall_vvir), h5::datatype::native_float,
            "infall_vvir");
    der.add(h5::datatype::native_float, HOFFSET(galaxy, infall_vmax), h5::datatype::native_float,
            "infall_vmax");
                       ...
                       const double& box_size)
{
    ...
    for (double z : redshifts)
    {
        outfile_settings << "      <snapshot>" << std::fixed
                         << std::setprecision(12 - std::to_string((int)z).length()) << z
                         << "</snapshot>" << std::endl;
    }
    outfile_settings << "    </snapshots>" << std::endl;
    outfile_settings << "  </PGDB>" << std::endl;
