...
namespace tao {
   ...
   void
   xml_dict::read( const std::string& filename,
   ...
   bool
   xml_dict::has( const std::string& path ) const
   {
      return _get_node( path, false );
   }

   xpath_node_set
   xml_dict::get_nodes( const std::string& xpath ) const
   {
      return _root.select_nodes( xpath.c_str() );
   }

   xml_node
   xml_dict::get_root() const
   {
      return _root;
   }
   ...
   xml_node
   xml_dict::_get_node( const std::string& path,
                        bool except ) const
   {
   ...
   std::string
   xml_dict::_xform_path( const std::string& path ) const
   {
