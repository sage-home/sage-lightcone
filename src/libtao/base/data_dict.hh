...
public:
    data_dict() {}
    static void setFieldStats(std::vector<tao::data_dict_field>& fields, std::string name,
                              long long min, long long max);
    static void setFieldStats(std::vector<tao::data_dict_field>& fields, std::string name, int min,
                              int max);
    static void setFieldStats(std::vector<tao::data_dict_field>& fields, std::string name,
                              float min, float max);
    ...
    static hpc::h5::derive getCompositeANY(std::vector<tao::data_dict_field>& fields,
                                           hpc::h5::datatype& mdt, hpc::h5::datatype& fdt);
};
