...
public:
    ...
    ///
    void set_geometry(real_type ra_min, real_type ra_max, real_type dec_min, real_type dec_max,
                      real_type z_max, real_type z_min = 0);
    ...
    ///
    void set_random(bool rand, int rng_seed = -1, hpc::engine_type* engine = &hpc::engine);
    ...
    typename Backend::lightcone_galaxy_iterator galaxy_begin(query<real_type>& qry, Backend& be,
    ...
    template <class Backend>
    typename Backend::lightcone_galaxy_iterator galaxy_end(query<real_type>& qry, Backend& be)
    {
    ...
    bool overlap(std::array<real_type, 3> const& min, std::array<real_type, 3> const& max) const;
