...
simulation::simulation(real_type box_size, real_type hubble, real_type omega_m, real_type omega_l,
    ...
    : _box_size(box_size)
{
    ...
    {
        ASSERT(_zs[ii] < _zs[ii - 1], "Expansion factor list must be supplied in snapshot order, "
...
void simulation::set_cosmology(real_type hubble, real_type omega_m, real_type omega_l)
{
