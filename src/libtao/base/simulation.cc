...
namespace tao {
   ...
   simulation::simulation( real_type box_size,
                           real_type hubble,
                           real_type omega_m,
                           real_type omega_l,
   ...
   void
   simulation::set_box_size( real_type box_size )
   {
      _box_size = box_size;
   }

   real_type
   simulation::box_size() const
   {
      return _box_size;
   }

   void
   simulation::set_cosmology( real_type hubble,
                              real_type omega_m,
                              real_type omega_l )
   {
   ...
   real_type
   simulation::omega_m() const
   {
      return _omega_m;
   }

   real_type
   simulation::omega_l() const
   {
      return _omega_l;
   }

   real_type
   simulation::omega_r() const
   {
      return _omega_r;
   }

   real_type
   simulation::omega_k() const
   {
      return _omega_k;
   }

   unsigned
   simulation::num_snapshots() const
   {
      return _zs.size();
   }

   real_type
   simulation::redshift( unsigned snap ) const
   {
      return _zs.at(snap);
   }

   std::map<int, real_type> const&
